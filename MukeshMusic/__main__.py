...
async def init():
    ...
    LOGGER("rinXmusic.plugins").info(
        "Necessary Modules Imported Successfully."
    )
    await userbot.start()
    await Rin.start()
    try:
        await Rin.stream_call(
